...
edge_img = cv2.imread('C:/Users/HUAWEI/Desktop/Opencv/lane/lane_detect/masked_edge_img.jpg', cv2.IMREAD_GRAYSCALE)
# 获取所有线段
...
img = cv2.imread('C:/Users/HUAWEI/Desktop/Opencv/lane/lane_detect/img.jpg', cv2.IMREAD_COLOR)
